...
private slots:
    ...
    void on_BuyPARIS_clicked();
    void on_SellPARISBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputPARIS_textChanged(const QString &arg1);
    ...
    QString BuyPARIS(QString OrderType, double Quantity, double Rate);
    QString SellPARIS(QString OrderType, double Quantity, double Rate);
