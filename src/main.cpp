...
unsigned int nTargetSpacing = 1 * 30; // PARIS - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // PARIS - time to elapse before new modifier is computed
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PARIS", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://datanews.knack.be/ict/nieuws/paris-hilton-stapt-in-cryptocurrency/article-normal-896533.html";
        CTransaction txNew;
        txNew.nTime = 1504684612;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1504684612;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 26224018;
        ...
        assert(block.hashMerkleRoot == uint256("0xf01216a60bb7c568eed1baefa5609d6dba4cea9694246562dc6204202df6cc07"));
